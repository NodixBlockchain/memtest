...
module_rproc_ptr  queue_ping_message, node_has_service_module, node_get_root_app, node_get_root_app_addr, node_get_root_app_fee, node_get_mempool_hashes, node_get_apps, node_get_types_def, node_add_tmp_file, get_nscene, blog_get_ncats;
module_rwproc_ptr queue_pong_message, queue_getdata_message, queue_inv_message, node_get_app, node_get_app_types_def, node_get_app_objs, check_tx_files, get_scene_list, blog_get_cats, blog_get_cat_posts, blog_get_cat, blog_get_post, blog_get_last_posts;
